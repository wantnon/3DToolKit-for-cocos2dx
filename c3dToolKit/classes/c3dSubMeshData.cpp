...
void Cc3dSubMeshData::initPositionList(const float positionArray[],int positionArrayLen){
...
void Cc3dSubMeshData::initTexCoordList(const float texCoordArray[],int texCoordArrayLen){
...
void Cc3dSubMeshData::initNormalList(const float normalArray[],int normalArrayLen){
    m_normalList.clear();
...
void Cc3dSubMeshData::initColorList(const float colorArray[],int colorArrayLen){
    m_colorList.clear();
